...
|-----------|------|--------------|-------|
| `google/gemma-4-26b-a4b` | ~18 GB | 20-24 GB | **nlink-jp standard model. Verified.** |

> nlink-jp tools are developed and tested with **gemma-4-26b-a4b** (Gemma 4 27B Instruct, MoE with effective 4B parameter activation) as the standard model. Other models may work but have not been verified.
>
> Type `gemma-4-26b-a4b` in the search bar and select a GGUF quantized version (e.g., Q4_K_M). If VRAM is insufficient, LM Studio will automatically use hybrid CPU/GPU execution.
