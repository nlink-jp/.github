...
| [ir-hub](https://github.com/nlink-jp/ir-hub) | Go | ~~IR lifecycle hub — resident Slack ChatOps bot that opens a channel per case, tracks the response with ACL-gated commands, and ingests messages for postmortems and knowledge reuse~~ **Archived** — no longer used or maintained |
...
| [mcp-skeleton](https://github.com/nlink-jp/mcp-skeleton) | Python | ~~MCP server skeleton — raw JSON-RPC 2.0 over stdio/SSE with API key auth, for learning MCP internals~~ **Archived** — no longer used or maintained |
...
| [gem-transcribe](https://github.com/nlink-jp/gem-transcribe) | Python | ~~Audio transcription CLI built on Vertex AI Gemini — speaker name inference, multi-language output, structured JSON~~ **Archived** — superseded by [gem-scribe](https://github.com/nlink-jp/gem-scribe) |
...
| [quick-translate](https://github.com/nlink-jp/quick-translate) | Swift | ~~macOS menu-bar-resident translation tool — local LLM via OpenAI-compatible API~~ **Archived** — superseded by [instant-translate](https://github.com/nlink-jp/instant-translate) |
